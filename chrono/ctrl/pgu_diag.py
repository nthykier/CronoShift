...
if int(os.environ.get("DISABLE_PGU_WORKAROUNDS", "0")):
    class EnhancedFileDialog(gui.FileDialog):
        pass
else:
    ...
    class EnhancedFileDialog(gui.Dialog):
        ...
        def __init__(self, title_txt="File Browser", button_txt="Okay",
                     path=None, path_filter=None, cls="dialog"):
            ...
            Keyword arguments:
                ...
                path_filter -- filter function to hide some elements.
