\section{Game analysis} \sectionauthor{T. B. Nielsen}
...
perspective, the different methods for evaluating Playability will be
...
entirely skipping the tutorial for the very reason it was there.
...
A few things are reinforced though; the light aesthetics of a young
...
appeal. In Jikiban death is replaced by paradoxes, any ‘death’ of
...
\section{Player feedback} \sectionauthor{A. Bang and T. B. Nielsen}
...
\item Use questionnaires and software hooks to gather metrics, like
  ...
  proposed Sánchez et Al. \cite{sanchez09}.
\begin{itemize}
...
\item There were no hints at all, so the players had no help.
\end{itemize}

The players had trouble understanding the concepts of the game such as
how the ``stand still'' function works in the context of multiple player
...
due to a mistake.  This was deemed ``intentional''.
...
time.  The movativation issue was fixed by adding a score system, a
campaign mode and a sound effect to signify victory.
