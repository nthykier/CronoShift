...
There was also the issue of detecting if the ``current self'' was
stuck.  While there are some trivial cases that would be ``easy'' to
detect, in general it will probably be just as hard as solving the
level.
